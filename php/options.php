...
function add_admin_menu_style_settings() {
	...
	JWR_Plugin_Options::add_color_picker_field( 'Header Text Color', 'header_ftext_color', '#ffffff', 25 );
	JWR_Plugin_Options::add_color_picker_field( 'Active Header Background Color', 'active_header_background_color', '#820000', 25 );
	JWR_Plugin_Options::add_color_picker_field( 'Active Header Text Color', 'active_header_ftext_color', '#ffffff', 25 );
}
